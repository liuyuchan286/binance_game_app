...
class BedsideStatisticsIncomestatisticsPage extends StatelessWidget {

  static const routeName = '/bedsidestatisticsincomestatisticsPage';
      ...
      body: Container(
        ...
        child: ProviderWidget(
          ...
          init: (BedsideStatisticsViewModel model){
            ...
            model.bedsideBedsidestatisticsIncomestatistics(searchParam);
          },
  ...
  refreshList() {
    _bedsideStatisticsViewModel.bedsideBedsidestatisticsIncomestatistics(searchParam);
  }
}
