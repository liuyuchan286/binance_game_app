...
class BedsideStatisticsTableUsageStatisticsPage extends StatelessWidget {

  static const routeName = '/bedsidestatisticstableusagestatisticsPage';
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  ListSearchHospitalSelect(lineHeight: lineHeight, preferredSizeBoxh: preferredSizeBoxh, searchParam: searchParam,topHeight: preferredSizeHeight,hiddens: [false,false,true],),
                ],
              ),
            ),
          ),
        ...
        body: Container(
          ...
          child: ProviderWidget(
            ...
            init: (BedsideStatisticsViewModel model){
              ...
              model.bedsideBedsidestatisticsTableUsageStatistics(searchParam);
            },
            builder: (_,BedsideStatisticsViewModel model,c){
              if(model.loading) {
                return Center(child: CupertinoActivityIndicator());
              }
              return SimpleLineChart.withSampleData(model.modelDatas.first.createSampleData(),unit: '次',);
            },
          ),
        )
    );
  ...
  refreshList() {
    _bedsideStatisticsViewModel.bedsideBedsidestatisticsTableUsageStatistics(searchParam);
  }
}
