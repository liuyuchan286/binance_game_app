...
class BedsideStatisticsTableStatisticsPage extends StatelessWidget {

  static const routeName = '/bedsidestatisticstablestatisticsPage';
        ...
        body: Container(
          ...
          child: ProviderWidget(
            ...
            init: (BedsideStatisticsViewModel model){
              ...
              model.bedsideBedsidestatisticsTablestatistics(searchParam);
            },
  ...
  refreshList() {
    _bedsideStatisticsViewModel.bedsideBedsidestatisticsTablestatistics(searchParam);
  }
}
