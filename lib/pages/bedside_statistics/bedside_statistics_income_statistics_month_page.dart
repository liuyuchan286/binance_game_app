...
class BedsideStatisticsIncomeStatisticsMonthPage extends StatelessWidget {

  static const routeName = '/bedsidestatisticsincomestatisticsmonthPage';
        ...
        body: Container(
          ...
          child: ProviderWidget(
            ...
            init: (BedsideStatisticsViewModel model){
              _range = DateTimeRange(start: DateTime.now().subtract(Duration(days: 120)), end: DateTime.now().add(Duration(days:30)));
              searchParam['startTime'] = _range.start.toString();;
              searchParam['endTime'] = _range.end.toString();
              model.bedsideBedsidestatisticsIncomestatisticsMonth(searchParam);
            },
  ...
  refreshList() {
    _bedsideStatisticsViewModel.bedsideBedsidestatisticsIncomestatisticsMonth(searchParam);
  }
}
