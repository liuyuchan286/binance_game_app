...
class BedsideBedsideHospitalOfficeListModel {
  int _totalCount;
  int _pageSize;
  int _totalPage;
  int _currPage;
  List<BedsideBedsideHospitalOfficeListModelData> _list;

  int get totalCount => _totalCount;
  int get pageSize => _pageSize;
  int get totalPage => _totalPage;
  int get currPage => _currPage;
  List<BedsideBedsideHospitalOfficeListModelData> get list => _list;

  BedsideBedsideHospitalOfficeListModel({
      int totalCount,
      int pageSize,
      int totalPage,
      int currPage,
      List<BedsideBedsideHospitalOfficeListModelData> list}){
  ...
  BedsideBedsideHospitalOfficeListModel.fromJson(dynamic json) {
      ...
      if (json["list"] != null) {
        _list = [];
        json["list"].forEach((v) {
          _list.add(BedsideBedsideHospitalOfficeListModelData.fromJson(v));
        });
      }
  }
...
class BedsideBedsideHospitalOfficeListModelData extends SearchModel with SingleListPickerModel,BedsideAgentHospitalTableColumnModel{
  ...
  BedsideBedsideHospitalOfficeListModelData({
        this.id,
        this.hospitalId,
        this.name,
        this.createdAt,
  ...
  BedsideBedsideHospitalOfficeListModelData.fromJson(dynamic json) {
    id = json["id"];
  ...
  void replace(BedsideBedsideHospitalOfficeListModelData newData) {
  id = newData.id ?? id;
