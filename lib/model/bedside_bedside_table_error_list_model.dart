...
class BedsideBedsideTableErrorListModel {
  int _totalCount;
  int _pageSize;
  int _totalPage;
  int _currPage;
  List<BedsideBedsideTableErrorListModelData> _list;

  int get totalCount => _totalCount;
  int get pageSize => _pageSize;
  int get totalPage => _totalPage;
  int get currPage => _currPage;
  List<BedsideBedsideTableErrorListModelData> get list => _list;

  BedsideBedsideTableErrorListModel({
      int totalCount,
      int pageSize,
      int totalPage,
      int currPage,
      List<BedsideBedsideTableErrorListModelData> list}){
  ...
  BedsideBedsideTableErrorListModel.fromJson(dynamic json) {
      ...
      if (json["list"] != null) {
        _list = [];
        json["list"].forEach((v) {
          _list.add(BedsideBedsideTableErrorListModelData.fromJson(v));
        });
      }
  }
...
class BedsideBedsideTableErrorListModelData {
  ...
  BedsideBedsideTableErrorListModelData({
        this.id,
        this.deviceId,
        this.number,
        this.createdAt,
  ...
  BedsideBedsideTableErrorListModelData.fromJson(dynamic json) {
    id = json["id"];
  ...
  void replace(BedsideBedsideTableErrorListModelData newData) {
  id = newData.id ?? id;
