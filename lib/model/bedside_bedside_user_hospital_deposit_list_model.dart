...
class BedsideBedsideUserHospitalDepositListModel {
  int _totalCount;
  int _pageSize;
  int _totalPage;
  int _currPage;
  List<BedsideBedsideUserHospitalDepositListModelData> _list;

  int get totalCount => _totalCount;
  int get pageSize => _pageSize;
  int get totalPage => _totalPage;
  int get currPage => _currPage;
  List<BedsideBedsideUserHospitalDepositListModelData> get list => _list;

  BedsideBedsideUserHospitalDepositListModel({
      int totalCount,
      int pageSize,
      int totalPage,
      int currPage,
      List<BedsideBedsideUserHospitalDepositListModelData> list}){
  ...
  BedsideBedsideUserHospitalDepositListModel.fromJson(dynamic json) {
      ...
      if (json["list"] != null) {
        _list = [];
        json["list"].forEach((v) {
          _list.add(BedsideBedsideUserHospitalDepositListModelData.fromJson(v));
        });
      }
  }
...
class BedsideBedsideUserHospitalDepositListModelData {
  ...
  String updatedAt;
  String deletedAt;
  double refundingDeposit;


  BedsideBedsideUserHospitalDepositListModelData({
        this.id,
        this.userId,
        this.hospitalId,
        this.deposit,
        ...
        this.updatedAt,
        this.deletedAt,
        this.refundingDeposit,
      });

  BedsideBedsideUserHospitalDepositListModelData.fromJson(dynamic json) {
    id = json["id"];
    userId = json["userId"];
    ...
    refundingDeposit = json["refundingDeposit"];
  }

  void replace(BedsideBedsideUserHospitalDepositListModelData newData) {
  id = newData.id ?? id;
  ...
  refundingDeposit = newData.refundingDeposit ?? refundingDeposit;
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    map["refundingDeposit"] = refundingDeposit;
    return map;
  }
}
