...
class BedsideBedsideHospitalBedListModel {
  int _totalCount;
  int _pageSize;
  int _totalPage;
  int _currPage;
  List<BedsideBedsideHospitalBedListModelData> _list;

  int get totalCount => _totalCount;
  int get pageSize => _pageSize;
  int get totalPage => _totalPage;
  int get currPage => _currPage;
  List<BedsideBedsideHospitalBedListModelData> get list => _list;

  BedsideBedsideHospitalBedListModel({
      int totalCount,
      int pageSize,
      int totalPage,
      int currPage,
      List<BedsideBedsideHospitalBedListModelData> list}){
  ...
  BedsideBedsideHospitalBedListModel.fromJson(dynamic json) {
      ...
      if (json["list"] != null) {
        _list = [];
        json["list"].forEach((v) {
          _list.add(BedsideBedsideHospitalBedListModelData.fromJson(v));
        });
      }
  }
...
class BedsideBedsideHospitalBedListModelData extends SingleListPickerModel{
  ...
  BedsideBedsideHospitalBedListModelData({
        this.id,
        this.hospitalId,
        this.officeId,
        this.roomId,
  ...
  BedsideBedsideHospitalBedListModelData.fromJson(dynamic json) {
    id = json["id"];
  ...
  void replace(BedsideBedsideHospitalBedListModelData newData) {
  id = newData.id ?? id;
