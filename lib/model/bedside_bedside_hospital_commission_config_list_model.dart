...
class BedsideBedsideHospitalCommissionConfigListModel {
  int _totalCount;
  int _pageSize;
  int _totalPage;
  int _currPage;
  List<BedsideBedsideHospitalCommissionConfigListModelData> _list;

  int get totalCount => _totalCount;
  int get pageSize => _pageSize;
  int get totalPage => _totalPage;
  int get currPage => _currPage;
  List<BedsideBedsideHospitalCommissionConfigListModelData> get list => _list;

  BedsideBedsideHospitalCommissionConfigListModel({
      int totalCount,
      int pageSize,
      int totalPage,
      int currPage,
      List<BedsideBedsideHospitalCommissionConfigListModelData> list}){
  ...
  BedsideBedsideHospitalCommissionConfigListModel.fromJson(dynamic json) {
      ...
      if (json["list"] != null) {
        _list = [];
        json["list"].forEach((v) {
          _list.add(BedsideBedsideHospitalCommissionConfigListModelData.fromJson(v));
        });
      }
  }
...
class BedsideBedsideHospitalCommissionConfigListModelData {
  ...
  BedsideBedsideHospitalCommissionConfigListModelData({
        this.id,
        this.hospitalName,
  ...
  BedsideBedsideHospitalCommissionConfigListModelData.fromJson(dynamic json) {
    id = json["id"];
  ...
  void replace(BedsideBedsideHospitalCommissionConfigListModelData newData) {
  id = newData.id ?? id;
  hospitalName = newData.hospitalName ?? hospitalName;
  commissionRatio = newData.commissionRatio ?? commissionRatio;
  lateArrival = newData.lateArrival ?? lateArrival;
