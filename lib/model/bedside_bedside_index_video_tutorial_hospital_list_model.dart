...
class BedsideBedsideIndexVideoTutorialHospitalListModel {
  int _totalCount;
  int _pageSize;
  int _totalPage;
  int _currPage;
  List<BedsideBedsideIndexVideoTutorialHospitalListModelData> _list;

  int get totalCount => _totalCount;
  int get pageSize => _pageSize;
  int get totalPage => _totalPage;
  int get currPage => _currPage;
  List<BedsideBedsideIndexVideoTutorialHospitalListModelData> get list => _list;

  BedsideBedsideIndexVideoTutorialHospitalListModel({
      int totalCount,
      int pageSize,
      int totalPage,
      int currPage,
      List<BedsideBedsideIndexVideoTutorialHospitalListModelData> list}){
  ...
  BedsideBedsideIndexVideoTutorialHospitalListModel.fromJson(dynamic json) {
      ...
      if (json["list"] != null) {
        _list = [];
        json["list"].forEach((v) {
          _list.add(BedsideBedsideIndexVideoTutorialHospitalListModelData.fromJson(v));
        });
      }
  }
...
class BedsideBedsideIndexVideoTutorialHospitalListModelData with BedsideAgentHospitalTableColumnModel{


  int id;
  String name;
  int indexVideoTutorialId;
  String video;
  String remark;
  String createdAt;
  String updatedAt;
  ...
  BedsideBedsideIndexVideoTutorialHospitalListModelData({
        this.id,
        this.name,
        this.indexVideoTutorialId,
        this.video,
        this.remark,
        this.createdAt,
        this.updatedAt,
  ...
  BedsideBedsideIndexVideoTutorialHospitalListModelData.fromJson(dynamic json) {
    id = json["id"];
    name = json["name"];
    indexVideoTutorialId = json["indexVideoTutorialId"];
    video = json["video"];
    remark = json["remark"];
  ...
  void replace(BedsideBedsideIndexVideoTutorialHospitalListModelData newData) {
  id = newData.id ?? id;
  name = newData.name ?? name;
  indexVideoTutorialId = newData.indexVideoTutorialId ?? indexVideoTutorialId;
  ...
  Map<String, dynamic> toJson() {
    ...
    map["id"] = id;
    map["name"] = name;
    map["indexVideoTutorialId"] = indexVideoTutorialId;
    map["video"] = video;
    map["remark"] = remark;
  ...
  @override
  bool disabled() {
    return indexVideoTutorialId != null && infoId != indexVideoTutorialId;
  }

  @override
  bool selected() {
    if(infoId == null || indexVideoTutorialId == null) return false;
    return infoId == indexVideoTutorialId;
  }
