...
class BedsideBedsideGraphicTutorialListModel {
  int _totalCount;
  int _pageSize;
  int _totalPage;
  int _currPage;
  List<BedsideBedsideGraphicTutorialListModelData> _list;

  int get totalCount => _totalCount;
  int get pageSize => _pageSize;
  int get totalPage => _totalPage;
  int get currPage => _currPage;
  List<BedsideBedsideGraphicTutorialListModelData> get list => _list;

  BedsideBedsideGraphicTutorialListModel({
      int totalCount,
      int pageSize,
      int totalPage,
      int currPage,
      List<BedsideBedsideGraphicTutorialListModelData> list}){
  ...
  BedsideBedsideGraphicTutorialListModel.fromJson(dynamic json) {
      ...
      if (json["list"] != null) {
        _list = [];
        json["list"].forEach((v) {
          _list.add(BedsideBedsideGraphicTutorialListModelData.fromJson(v));
        });
      }
  }
...
class BedsideBedsideGraphicTutorialListModelData {
  ...
  BedsideBedsideGraphicTutorialListModelData({
        this.id,
        this.remark,
        this.content,
        this.createdAt,
  ...
  BedsideBedsideGraphicTutorialListModelData.fromJson(dynamic json) {
    id = json["id"];
    remark = json["remark"];
  ...
  void replace(BedsideBedsideGraphicTutorialListModelData newData) {
  id = newData.id ?? id;
