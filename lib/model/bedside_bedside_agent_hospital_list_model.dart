...
class BedsideBedsideAgentHospitalListModel {
  int _totalCount;
  int _pageSize;
  int _totalPage;
  int _currPage;
  List<BedsideBedsideAgentHospitalListModelData> _list;

  int get totalCount => _totalCount;
  int get pageSize => _pageSize;
  int get totalPage => _totalPage;
  int get currPage => _currPage;
  List<BedsideBedsideAgentHospitalListModelData> get list => _list;

  BedsideBedsideAgentHospitalListModel({
      int totalCount,
      int pageSize,
      int totalPage,
      int currPage,
      List<BedsideBedsideAgentHospitalListModelData> list}){
  ...
  BedsideBedsideAgentHospitalListModel.fromJson(dynamic json) {
      ...
      if (json["list"] != null) {
        _list = [];
        json["list"].forEach((v) {
          _list.add(BedsideBedsideAgentHospitalListModelData.fromJson(v));
        });
      }
  }
...
class BedsideBedsideAgentHospitalListModelData {
  ...
  BedsideBedsideAgentHospitalListModelData({
        this.id,
        this.agentId,
        this.hospitalId,
        this.createdAt,
  ...
  BedsideBedsideAgentHospitalListModelData.fromJson(dynamic json) {
    id = json["id"];
  ...
  void replace(BedsideBedsideAgentHospitalListModelData newData) {
  id = newData.id ?? id;
  agentId = newData.agentId ?? agentId;
  hospitalId = newData.hospitalId ?? hospitalId;
  hospitalIds = newData.hospitalIds ?? hospitalIds;
