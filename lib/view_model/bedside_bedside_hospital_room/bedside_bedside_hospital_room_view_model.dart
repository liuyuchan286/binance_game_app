...
class BedsideBedsideHospitalRoomViewModel extends BaseViewModel{
  ...
  void bedsideBedsideHospitalRoomListAll(int officeId) {
  ...
  void refreshList(BedsideBedsideHospitalRoomListModelData data,int index) {
    if(index == null) {
      this.bedsideBedsideHospitalRoomListModelDatas[0].replace(data);
    }else {
      this.bedsideBedsideHospitalRoomListModelDatas[index].replace(data);
    }
