...
class BedsideBedsideHospitalOfficeViewModel extends BaseViewModel{
  ...
  void bedsideBedsideHospitalOfficeListAll(int hospitalId) {
  ...
  void refreshList(BedsideBedsideHospitalOfficeListModelData data,int index) {
    if(index == null) {
      this.bedsideBedsideHospitalOfficeListModelDatas[0].replace(data);
    }else {
      this.bedsideBedsideHospitalOfficeListModelDatas[index].replace(data);
    }
